...
/**
 * Список дел ●Создайте список строк(List) ●Положите в список 5 дел на день ●в цикле выведите список
 * в формате: ○ Задача1:{текстзадачи} ○ Задача2:{текстзадачи} ○... ○ Задача5:{текстзадачи}
 */
